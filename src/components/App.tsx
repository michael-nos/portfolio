  ...
  <div className='app'>
    ...
    <div className='app-bio-container'>
      <p>
        ...
        development using both monolithic and microservice architecture. I enjoy
        learning about new technologies to further develop my skillset and to
        embrace the change in our ever-expanding web ecosystem.
      </p>
    </div>
